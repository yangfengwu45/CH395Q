...
#line 66 "..\\SYSTEM\\System_Init.c"
		...
		RCC_APB2PeriphClockCmd( ((u32)0x00000004) | ((u32)0x00000008)  | ((u32)0x00000010) |
								((u32)0x00000020) | ((u32)0x00004000) | ((u32)0x00000200), ENABLE );
...
void UART_Configuration(void)
{
	...
	USART_ITConfig( ((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0525), ENABLE );			 				 
...
void Timer_Configuration(void)
{
	...
	TIM_ITConfig(((TIM_TypeDef *) (((u32)0x40000000) + 0x0000)), ((u16)0x0001), ENABLE );
}
