...
void USART1_IRQHandler(void)
{
	if(USART_GetITStatus(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0525)) != RESET)
	{
		 
		USART_ClearITPendingBit(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0525));

	}

	if(USART_GetITStatus(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0626)) != RESET)
	{
		 
		USART_ClearITPendingBit(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0626));
	}
}
