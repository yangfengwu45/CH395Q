...
UINT8 CH395MACAddr[6] = {0x02,0x03,0x04,0x5,0x6,0x7};                /* Mac地址，CH395Mac地址出厂已经烧录，此程序关于MAC地址设置仅供演示*/
/* socket 相关定义*/
const UINT8  BroadcastIP[4] = {255,255,255,255};                     /* UDP 广播地址 */
const UINT16 Socket0DesPort = 5000;                                  /* Socket 0目的端口 */
const UINT16 Socket0SourPort = 5000;                                 /* Socket 0源端口 */

UINT8  MulticastIP[4] = {234,5,6,7};                                 /* 多播IP地址 */
UINT8 MultiMac[6]  = {1,0,0x5e,5,6,7};                               /* 对应多播Mac地址 */
UINT8 TestBuf[10]={  'R','e','c','v','d','a','t','a','!'};
...
#endif
       CH395UDPSendTo(TestBuf, DataLen,MulticastIP, Socket0DesPort, sockindex);
       return;       
   }
...
UINT8  CH395Init(void)
{
    ...
    CH395CMDSetMACAddr(CH395Inf.MacAddr);
...
int main(void)
{
    ...
    MacCrc32 =  CH395CRCRet6Bit(MultiMac);
    printf("MacCrc32 : %2x\n",(UINT16)MacCrc32);
    if(MacCrc32 > 31)
    {
      MacCrc32 -=31;
